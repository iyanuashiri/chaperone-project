...
function showModal(timeLimit, tabId) {
    // Synonym question generation
    const synonymPairs = [
        { word: "happy", synonym: "joyful", distractors: ["angry", "sad", "tired"] },
        { word: "big", synonym: "large", distractors: ["small", "tiny", "short"] },
        { word: "fast", synonym: "quick", distractors: ["slow", "steady", "calm"] },
        { word: "smart", synonym: "intelligent", distractors: ["foolish", "ignorant", "careless"] },
        { word: "beautiful", synonym: "gorgeous", distractors: ["ugly", "plain", "messy"] },
        { word: "brave", synonym: "courageous", distractors: ["afraid", "timid", "nervous"] },
        { word: "calm", synonym: "peaceful", distractors: ["agitated", "upset", "anxious"] },
        { word: "cold", synonym: "chilly", distractors: ["hot", "warm", "burning"] },
        { word: "correct", synonym: "accurate", distractors: ["wrong", "false", "mistaken"] },
        { word: "difficult", synonym: "challenging", distractors: ["easy", "simple", "effortless"] },
        { word: "famous", synonym: "renowned", distractors: ["unknown", "obscure", "anonymous"] },
        { word: "funny", synonym: "humorous", distractors: ["serious", "boring", "dull"] },
        { word: "honest", synonym: "truthful", distractors: ["deceptive", "dishonest", "fraudulent"] },
        { word: "important", synonym: "significant", distractors: ["trivial", "minor", "negligible"] },
        { word: "loud", synonym: "noisy", distractors: ["quiet", "silent", "soft"] }
    ];

    // Select a random synonym pair
    const randomIndex = Math.floor(Math.random() * synonymPairs.length);
    const selectedPair = synonymPairs[randomIndex];
    
    // Create array of options with the correct synonym and distractors
    const options = [selectedPair.synonym, ...selectedPair.distractors];
    
    // Shuffle options
    const shuffledOptions = shuffleArray(options);
    
    const correctAnswer = selectedPair.synonym;
    const questionWord = selectedPair.word;
    ...
    // Stage 1: Synonym Challenge
    function showSynonymChallenge() {
